...
BEGIN_DEFINE_SPEC(FRSQosApiSpec_FailureTests, "QosSDK.FQosApi.FailureTests", EAutomationTestFlags::ProductFilter | EAutomationTestFlags_ApplicationContextMask)
#else
BEGIN_DEFINE_SPEC(FQosApiSpec_FailureTests, "QosSDK.FQosApi.FailureTests", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
#endif
