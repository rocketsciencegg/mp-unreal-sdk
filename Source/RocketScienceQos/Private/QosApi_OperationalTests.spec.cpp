...
BEGIN_DEFINE_SPEC(FRSQosApiSpec_OperationalTests, "QosSDK.FQosApi.OperationalTests", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
