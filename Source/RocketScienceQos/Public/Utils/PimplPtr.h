...
// We have included this file ourselves as lower versions of UE don't have a PimplPtr definition however we need to support UE 4.22 - 5.0.
// This definition has been pulled from UE 5 as it is backwards compatible with all versions and therefore supports UE versions 4.22 - 5.0 whereas older definitions aren't forward compatible. 
...
// This macro is undefined in UE version 4.24 and below
#ifndef UE_ASSUME
